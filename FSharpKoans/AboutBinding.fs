...
*)
    ...
    let ``07 Shadowing`` () =
        ...
        let c = a + 4
        let a = a + a
        a |> should equal 42//*__
        b |> should equal 11
        c |> should equal 25 //*__
   ...
   *)
    ...
    let ``08 An identifier pattern will match anything`` () =
        ...
        let z = 2.0 // replace with anything else!
    ...
    let ``09 A wildcard pattern will match anything`` () =
        ...
        let _ = "word" // replace with a string
        let _ = 2.0 // replace with anything else!
        ()
